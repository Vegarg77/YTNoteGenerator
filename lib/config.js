...
// it, e.g. to a host file bind-mounted into a container or kept outside the repo so it
// also survives fresh clones. Read lazily so tests and launch-time env can set it.
function getEnvPath() {
